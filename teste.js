(function () {
  function abrirPainelRenomear() {
        ...
        <table class="vis" style="width:100%; margin-top:4px;">
          ...
          <tr>
            <td colspan="2" style="text-align:center; padding-top:4px;">
              ...
              <input id="totalTropas" type="button" class="btn" value="Total Tropas">
            </td>
          </tr>
        </table>
    ...
    // Botão Total Tropas
    $('#totalTropas').on('click', () => {
      $.getScript('https://tribalwarstools.github.io/twscripts/TotalTropas.js')
        .done(() => {
          UI.SuccessMessage('Script Total Tropas carregado com sucesso.');
        })
        .fail(() => {
          UI.ErrorMessage('Falha ao carregar o script Total Tropas.');
        });
    });
  }
