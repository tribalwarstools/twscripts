(function() {
  ...
  const scripts = [
    ...
    { nome: 'Envio Imediato', func: () => { $.getScript('https://tribalwarstools.github.io/twscripts/EnvioImediato.js').done(() => UI.InfoMessage('✅ Script carregado!',3000,'success')).fail(() => UI.InfoMessage('❌ Erro ao carregar script.',5000,'error')); }},
