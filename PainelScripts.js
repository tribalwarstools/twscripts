(function() {
  ...
  // === Lista de Scripts ===
  const scripts = [
	{ nome: 'Comparador(Casual)', func: () => { $.getScript('https://cdn.jsdelivr.net/gh/TribalWarsTools/twscripts/BuscarAldeiasRaio.js').done(() => UI.InfoMessage('✅ Script carregado!', 3000,'success')).fail(() => UI.InfoMessage('❌ Erro ao carregar script.',5000,'error')); }},  
