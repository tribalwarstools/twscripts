(function() {
  ...
  const scripts = [
    ...
    { nome: 'Recrutamento', func: () => { $.getScript('https://tribalwarstools.github.io/beta/recrutamento.js').done(() => UI.InfoMessage('✅ Script  carregado!', 3000,'success')).fail(() => UI.InfoMessage('❌ Erro ao carregar script .',5000,'error')); }},
    // === Scripts Farm ===
