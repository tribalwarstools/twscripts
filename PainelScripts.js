(function() {
  ...
  const scripts = [
	...
	{ nome: 'Snipe', func: () => { $.getScript('https://cdn.jsdelivr.net/gh/TribalWarsTools/twscripts/snipe.js').done(() => UI.InfoMessage('✅ Script carregado!',3000,'success')).fail(() => UI.InfoMessage('❌ Erro ao carregar script.',5000,'error')); }},
	{ nome: 'Evolução', func: () => { $.getScript('https://cdn.jsdelivr.net/gh/TribalWarsTools/beta/evolucao.js').done(() => UI.InfoMessage('✅ Script carregado!',3000,'success')).fail(() => UI.InfoMessage('❌ Erro ao carregar script.',5000,'error')); }},
