function abrirJanelaGrupo() {
    ...
    let htmlCoordenadas = `<div class="vis">
        <table class="vis">
            <textarea id="campoCoordenadas" cols="30" rows="6" placeholder="Digite as coordenadas aqui 2.0"></textarea>
    ...
    function importarCoordenadas() {
        ...
        // Criar formulário para enviar aldeias ao grupo com os botões corretos
        ...
        formulario += `</select><br><br>
            ...
            <input class="btn" type="submit" name="set_group" value="Mover para grupo">
...
// Tornar a função principal disponível globalmente
